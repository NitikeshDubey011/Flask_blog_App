...
def register():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login'))  # name of the function
...
def account():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            picture_file = SavePictures(form.picture.data)
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent eith instructions to reset your password.')
...
def reset_token(token):
    ...
    if user is None:
        flash('That is and expired token','warning')
